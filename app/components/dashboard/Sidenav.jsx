...
const Sidenav = () => {
  ...
  return (
    <aside className={`${isMinimize ? 'lg:w-fit' : 'lg:w-72'} w-full bg-neutral-900 text-gray-400 h-fit lg:h-screen rounded-none lg:rounded-r-lg flex flex-col justify-between items-start transition-all ease-in-out duration-300 shadow-xl order-2 lg:order-1 font-bold sticky bottom-0 left-0 lg:top-0`}>
